...
[![8.png](image-202010031632/5b2008f4c1003.png)](https://i.loli.net/2018/06/13/5b2008f4c1003.png)

为了能看出 Guava 是怎么删除过期数据的在获取缓存之前休眠了 5 秒钟，达到了超时条件。

[![2.png](image-202010031632/5b1ffe4eebae0.png)](https://i.loli.net/2018/06/13/5b1ffe4eebae0.png)
...
[![3.png](image-202010031632/5b1fffc88c3e6.png)](https://i.loli.net/2018/06/13/5b1fffc88c3e6.png)

2761 行，根据方法名称可以看出是判断当前的 Entry 是否过期，该 entry 就是通过 key 查询到的。

[![img](image-202010031632/5cd1d2f2b95ed.jpg)](https://i.loli.net/2019/05/08/5cd1d2f2b95ed.jpg)

这里就很明显的看出是根据根据构建时指定的过期方式来判断当前 key 是否过期了。

[![5.png](image-202010031632/5b20017f32ff0.png)](https://i.loli.net/2018/06/13/5b20017f32ff0.png)

如果过期就往下走，尝试进行过期删除（需要加锁，后面会具体讨论）。

[![6.png](image-202010031632/5b2001eeb40d5.png)](https://i.loli.net/2018/06/13/5b2001eeb40d5.png)
...
[![7.png](image-202010031632/5b20040d257cb.png)](https://i.loli.net/2018/06/13/5b20040d257cb.png)
